...
export default function DepenseParChapitre() {
  ...
  const handlePrint = useReactToPrint({
    ...
    function add () {
      var marcheCollectionRef = query(collection(db, "Marche"),where("chapitre", "==", numero))
      ...
      var marcheCollectionRef1 = query(collection(db, "Bon de Commande"),where("chapitre", "==", numero))
      ...
      var marcheCollectionRef2 =query(collectionGroup(db,"decompte"),where("chapitre", "==", numero)) 
      onSnapshot(marcheCollectionRef2, snapshot => {
        ...
        snapshot.docs.map(doc => {
             ...
             var pDecompte = parseFloat(getDecompte);
             sum3 += pDecompte;
             setDecompte(sum3);
 ...
 <Footer2 />
<br/><br/>
<h1 id = "titre">Dépenses Par Chapitres</h1>
<br/>
<div className="mb-3 row">
    <label htmlFor="inputPassword" className="col-sm-2 col-form-label">N° du chapitre</label>
